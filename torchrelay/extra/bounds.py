...
| ------------------------------------------------ | ----------- | -------------------------------- | ----------------------- | ------------------------- |
| [`replicate`](torchrelay.extra.bounds.replicate) | border      | nearest, replicate               | repeat                  | ` a  a | a b c d |  d  d` |
| `zero`                                           | constant(0) | constant, zero                   | zeros                   | ` 0  0 | a b c d |  0  0` |
| [`dct2`](torchrelay.extra.bounds.dct2)           | reflect     | reflection (align_corners=True)  | neumann                 | ` b  a | a b c d |  d  c` |
| [`dct1`](torchrelay.extra.bounds.dct1)           | mirror      | reflection (align_corners=False) |                         | ` c  b | a b c d |  c  b` |
| [`dft`](torchrelay.extra.bounds.dft)             | wrap        | circular                         |                         | ` c  d | a b c d |  a  b` |
| [`dst2`](torchrelay.extra.bounds.dst2)           |             |                                  | antireflect, dirichlet  | `-b -a | a b c d | -d -c` |
| [`dst1`](torchrelay.extra.bounds.dst1)           |             |                                  | antimirror              | `-a  0 | a b c d |  0 -d` |
"""  # noqa: E501
__all__ = [
    'to_nitorch', 'to_scipy', 'to_torch',
    'replicate', 'border', 'nearest', 'repeat',
    'dct2', 'reflect', 'neumann',
    'dct1', 'mirror',
    'dft', 'wrap', 'circular',
